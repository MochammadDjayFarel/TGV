    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-2 text-gray-800">Edit Jadwal Penerbangan</h1>
                    <p class="mb-0 text-muted">Edit jadwal penerbangan {{ $flightSchedule->flight_number }}</p>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-radius: 1rem;">
                ...
                <div class="card-body">
                    <form id="jadwalForm" method="POST" action="{{ route('staff.jadwal.update', $flightSchedule) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('flight_number') is-invalid @enderror" id="flight_number" name="flight_number" value="{{ old('flight_number', $flightSchedule->flight_number) }}" readonly>
                                @error('flight_number')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('departure_airport_id') is-invalid @enderror" id="departure_airport_id" name="departure_airport_id" required>
                                    ...
                                    @foreach($airports as $airport)
                                        <option value="{{ $airport->id }}" {{ old('departure_airport_id', $flightSchedule->departure_airport_id) == $airport->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('arrival_airport_id') is-invalid @enderror" id="arrival_airport_id" name="arrival_airport_id" required>
                                    ...
                                    @foreach($airports as $airport)
                                        <option value="{{ $airport->id }}" {{ old('arrival_airport_id', $flightSchedule->arrival_airport_id) == $airport->id ? 'selected' : '' }}>
                                            {{ $airport->name }} ({{ $airport->code }})
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('departure_time') is-invalid @enderror" id="departure_time" name="departure_time" value="{{ old('departure_time', $flightSchedule->departure_time->format('Y-m-d\TH:i')) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('arrival_time') is-invalid @enderror" id="arrival_time" name="arrival_time" value="{{ old('arrival_time', $flightSchedule->arrival_time->format('Y-m-d\TH:i')) }}" required>
                                @error('arrival_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('airline_id') is-invalid @enderror" id="airline_id" name="airline_id" required>
                                    ...
                                    @foreach($airlines as $airline)
                                        <option value="{{ $airline->id }}" {{ old('airline_id', $flightSchedule->airline_id) == $airline->id ? 'selected' : '' }}>
                                            {{ $airline->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('pilot_id') is-invalid @enderror" id="pilot_id" name="pilot_id" required>
                                    ...
                                    @foreach($pilots as $pilot)
                                        <option value="{{ $pilot->id }}" {{ old('pilot_id', $flightSchedule->pilot_id) == $pilot->id ? 'selected' : '' }}>
                                            {{ $pilot->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('co_pilot_id') is-invalid @enderror" id="co_pilot_id" name="co_pilot_id">
                                    ...
                                    @foreach($coPilots as $coPilot)
                                        <option value="{{ $coPilot->id }}" {{ old('co_pilot_id', $flightSchedule->co_pilot_id) == $coPilot->id ? 'selected' : '' }}>
                                            {{ $coPilot->name }}
                                        </option>
                                    @endforeach
                                </select>
